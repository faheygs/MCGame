...
namespace MCGame.Police
{
    ...
    /// Each crime has a name, base heat amount, and severity tier.
    /// Used by CrimeReporter to determine consequences when crimes are witnessed.
    /// </summary>
    [CreateAssetMenu(fileName = "CrimeType_", menuName = "MCGame/Police/Crime Type")]
    public class CrimeType : ScriptableObject
    {
        [Header("Crime Identity")]
        [Tooltip("Human-readable crime name (e.g., 'Assault', 'Murder', 'Grand Theft Auto')")]
